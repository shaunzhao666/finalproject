...
- target: have heart disease = 1; no = 0""")
    ...
    with ml: 
        ...
        with lsvm:
            ...
            st.markdown("#### The hyperparmeter of linear SVM is C, so we are gonna research the influence of test size and C upon the model's accuracy")
        ...
        with svm:
            st.header("RBF SVM")
            st.markdown("#### The hyperparmeter of RBF SVM is gamma and C")
